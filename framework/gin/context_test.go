...
import (
	...
	testdata "a-projects/geekbang/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?a-projects/geekbang/framework/gin.handlerNameTest$", c.HandlerName())
}
