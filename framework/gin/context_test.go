...
import (
	...
	testdata "github.com/JiadeXu/jade/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/JiadeXu/jade/framework/gin.handlerNameTest$", c.HandlerName())
}
