...
func NewJadeTraceService(params ...interface{}) (interface{}, error) {
	c := params[0].(framework.Container)
	idService := c.MustMake(contract.IDKey).(contract.IDService)
	return &JadeTraceService{
		idService: idService,
	}, nil
}

// WithContext register new trace to context
func (t *JadeTraceService) WithTrace(c context.Context, trace *contract.TraceContext) context.Context {
...
func (t *JadeTraceService) GetTrace(c context.Context) *contract.TraceContext {
	if ginC, ok := c.(*gin.Context); ok {
...
func (t *JadeTraceService) NewTrace() *contract.TraceContext {
...
func (t *JadeTraceService) StartSpan(trace *contract.TraceContext) *contract.TraceContext {
...
// GetTrace By Http
func (t *JadeTraceService) ExtractHTTP(req *http.Request) *contract.TraceContext {
	tc := &contract.TraceContext{}
...
// Set Trace to Http
func (t *JadeTraceService) InjectHTTP(req *http.Request, tc *contract.TraceContext) *http.Request {
...
func (t *JadeTraceService) ToMap(tc *contract.TraceContext) map[string]string {
	m := map[string]string{}
	if tc == nil {
		return m
	}
...
// func (t *JadeTraceService) SetTraceIDService(service contract.IDService) {
// 	t.traceIDGenerator = service
// }

// func (t *JadeTraceService) SetSpanIDService(service contract.IDService) {
